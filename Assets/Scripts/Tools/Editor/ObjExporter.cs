...
public class ObjExporterScript
{
    ...
    public static string MeshToString(MeshFilter meshFilter, Transform t)
    {
...
{
    [MenuItem("Assets/File/Export/Wavefront OBJ")]
    static void DoExportWSubmeshes()
    {
        DoExport(true);
    }

    [MenuItem("Assets/File/Export/Wavefront OBJ (No Submeshes)")]
